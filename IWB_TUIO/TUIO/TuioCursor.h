...
namespace TUIO {
	...
	public:
		 ...
		 */
		TuioCursor (TuioTime ttime, long si, int ci, float xp, float yp, int dwCameraId, int gunId);
		 ...
		 * @param	yp	the Y coordinate to assign
		 */
		TuioCursor (long si, int ci, float xp, float yp, int dwCameraId, int gunId);
