...
BOOL CVideoPlayer::StartDetect( HWND hPlayWnd, const RECT& rcDispArea, HWND hNotifyWnd, LPCTSTR lpszDevicePath,  const VIDEOINFOHEADER* pVideoInfoHeader)
{
    ...
    OutputDebugString(L" xxxxx StartDetect\n");
    OutputDebugString(lpszDevicePath);
    OutputDebugString(L" xxxxx StartDetect\n");
...
//@功能:在视频画面中显示文字
void CVideoPlayer::SetDisplayInfo(LPCTSTR lpszInfo, int nDisplayTimes, BOOL isSingleLine)
{
    ...
    else
    {
        AddOSDText(
            ...
            lpszInfo,
            rcDisplayArea,
            DT_VCENTER | DT_CENTER | DT_WORDBREAK | DT_VCENTER,
            40L,
            _T("Times New Roman"),
            nDisplayTimes);
    }
